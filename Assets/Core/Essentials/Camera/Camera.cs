...
namespace Cappa.Core
{
    ...
    /// <summary>
    /// The default camera, which is used, when no players are on scene;
    /// </summary>
    private UnityEngine.Camera MainCamera
    {
        get
        {
            var mngr = FindObjectOfType<GameManager>();

            var camera = mngr.MainCamera;
    ...
    /// <summary>
    /// Makes turns every camera off for the local player except this one;
    /// </summary>
    private void GrabAttention()
    {
